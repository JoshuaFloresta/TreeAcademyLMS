...
export default function AuthPage({ onAuthenticated }) {
  ...
  const submitActivation = async (values) => {
    ...
    try {
      const user = await activate(activationToken, values.password)
      onAuthenticated(user)
      navigate('/dashboard')
    } catch (error) {
